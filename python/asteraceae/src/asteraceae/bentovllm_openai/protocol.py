...
class ChatCompletionRequest(OpenAIBaseModel):
  ...
  guided_json: Optional[Union[str, dict, BaseModel]] = Field(
    default=None, description=('If specified, the output will follow the JSON schema.')
  )
  guided_regex: Optional[str] = Field(
    default=None, description=('If specified, the output will follow the regex pattern.')
  )
  guided_choice: Optional[List[str]] = Field(
    default=None, description=('If specified, the output will be exactly one of the choices.')
  )
  guided_grammar: Optional[str] = Field(
    default=None, description=('If specified, the output will follow the context free grammar.')
  )
  ...
  def to_sampling_params(
    self, tokenizer: AnyTokenizer, guided_decode_logits_processor: Optional[LogitsProcessor], default_max_tokens: int
  ) -> SamplingParams:
    ...
    logits_processors = get_logits_processors(logit_bias=self.logit_bias, allowed_token_ids=None, tokenizer=tokenizer)
...
class CompletionRequest(OpenAIBaseModel):
  ...
  add_special_tokens: bool = Field(
    default=True, description=('If true (the default), special tokens (e.g. BOS) will be added to ' 'the prompt.')
  )
  ...
  def to_sampling_params(
    ...
    logits_processors = get_logits_processors(
      logit_bias=self.logit_bias, allowed_token_ids=self.allowed_token_ids, tokenizer=tokenizer
    )
    if guided_decode_logits_processor:
      logits_processors.append(guided_decode_logits_processor)
