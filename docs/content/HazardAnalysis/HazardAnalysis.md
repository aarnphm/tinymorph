...
| Network connections  | Network outages                                                                 | interrupt users flow                                            | a. Electrical outage<br>b. Network congestion<br>c. Server outage                                                                                                                                       | a. Display a toast warning about network outage<br>b. Recommendation to save locally<br>c. Same as H1.1                           | [[SRS/SRS#9.1 Functional Requirements\|FR-9]]                                                                                                    | H3.1 |     |
...
| General              | Overall system unresponsiveness                                                 | Users unable to use the system                                  | a. Memory leak<br>b. Browser limitation<br>c. Resource starvation                                                                                                                                       | a. Optimize memory usage<br>b. Implement early degradation detection and display warning                                          | [[SRS/SRS#20.4 Limitations in the Anticipated Implementation Environment That May Inhibit the New Product\|LAIETMINP-1]]                                                                                             | H5.1 |     |
...
| Infrastructure       | Downtime                                                                        | Interruption in users' workflow                                 | a. SLO and third-party service downtimw                                                                                                                                                                 | a. Same as H2.1<br>b. Add rollback and scaling for backup region                                                                  | [[SRS/SRS#15.4 Audit Requirements\|SR-AU1]]                                                                                                   | H7.1 |     |
